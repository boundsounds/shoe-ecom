    ...
    <div>
      <Box display="flex" alignItems="center" justifyContent="start" padding="2rem" sx={{ backgroundColor: '#E7E5D8' }}>
        ...
        <Container sx={{ display: 'flex', marginTop: '1rem', flexDirection: 'column' }}>
          <Typography variant="h1" sx={{ letterSpacing: '-4.0px' }}>
            welcome to the future of shoes{' '}
            <span>
          ...
          <Box justifyContent="center" alignItems="center" mt={2}>
            <Link href={'./shop'}>
              <Button
                variant="contained"
                sx={{ backgroundColor: 'black', borderRadius: '32px', width: '100%', maxWidth: '400px', height: '60px', color: '#f5f5f5' }}
              >
                Get started
              </Button>
            </Link>
      ...
      <Box display="flex" flexDirection="column" justifyContent="center" sx={{ padding: '4rem' }}>
        <Box display="flex" alignItems="start" justifyContent="start" padding="2rem" flexDirection="column">
          <Typography variant="h1" sx={{}}>find your style<span>
            <svg clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" width="48" height="48" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <Box display="flex" alignItems="end" justifyContent="start" padding="2rem" flexDirection="column">
          <Typography variant="h1" sx={{}}>find your time<span>
            <svg clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" width="48" height="48" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="m9.001 13.022h-3.251c-.412 0-.75.335-.75.752 0 .188.071.375.206.518 1.685 1.775 4.692 4.945 6.069 6.396.189.2.452.312.725.312.274 0 .536-.112.725-.312 1.377-1.451 4.385-4.621 6.068-6.396.136-.143.207-.33.207-.518 0-.417-.337-.752-.75-.752h-3.251v-9.02c0-.531-.47-1.002-1-1.002h-3.998c-.53 0-1 .471-1 1.002z" fillRule="nonzero" />
            </svg>
          </span></Typography>
          <Typography variant="h6" sx={{ letterSpacing: '-1.5px' }}>
            whether you need them for a day, a week or a month we have options tailored for your lifestyle
          </Typography>

        </Box>
        <Box display="flex" justifyContent="start" padding="2rem" flexDirection="column">
          <Typography variant="h1" sx={{}}>send them back<span>
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
              <path d="M24 12l-9-8v6h-15v4h15v6z" />
            </svg>
          </span></Typography>
      ...
      >
        <Typography variant="h1" sx={{ letterSpacing: '-4.0px' }}>any other questions?<span>
          <svg
            clipRule="evenodd"
            fillRule="evenodd"
